" Vim syntax file
" Language:	DADL (data Archetype Description Language)
" Maintainer:	Thomas Beale (thomas.beale@oceaninformatics.com)
" URL:		http://www.oceanInformatics.com/vim/syntax/dadl.vim
